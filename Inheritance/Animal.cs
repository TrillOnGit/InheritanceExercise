...
public class Animal
{
    ...
    public static void DisplayValues(Reptile rep, Bird birb)
    {
        ...
        Console.WriteLine(rep.HasTeeth ? (rep.RegrowingTeeth ? $"Its teeth {rep.RegrowingTeeth}ly regrow!" : "Its teeth don't regrow..." ): $"Does it have teeth? {rep.HasTeeth} it doesn't!");
        ...
        Console.WriteLine(birb.FliesSolo ? $"It flies alone, flapping its {birb.NumberOfWings} wings." : $"It uses its {birb.NumberOfWings} wings to fly in a group!");
        
        Console.WriteLine(birb.HasFeathers ? $"The {birb.Name}'s wings are feathered." : "Its wings are featherless.");
